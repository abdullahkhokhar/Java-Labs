...
public class PlayWithShapes {
	...
	public PlayWithShapes() {
		...
		shapes[3]=new Circle("blue", 15, 10,10);
		shapes[4]=new Circle("purple", 20, 30, 10);
		shapes[5]=new Rectangle("black", 3, 15, 25, 45);
		shapes[6]=new Circle("brown", 1, 2,2);
		shapes[7]=new Circle("pink", 24, 24, 14);
		shapes[8]=new Rectangle("yellow", 10, 10, 10, 10);
		shapes[9]=new Rectangle("silver", 2, 2, 2, 2);
		// ...
